...
\acmYear{2017} % Insert Publication year
\copyrightyear{2017} % Insert Copyright year (typically the same as above)
\acmPrice{15.00}
\acmConference[SenSys]{The 16th ACM Conference on Embedded Network Sensor Systems}{November 4-7, 2018}
{Shenzhen, China}

\hyphenation{WISP RFID CRFID CRFIDs RF volt-age}
\newcommand{\sysname}{Waldo\xspace}
\newcommand{\numExp}{651\xspace}
\newcommand{\numDet}{634\xspace}
\newcommand{\numDir}{605\xspace}
\newcommand{\numDoors}{6\xspace}
\newcommand{\numPeople}{12\xspace}
\newcommand{\SysAccuracy}{97.38\%\xspace}
\newcommand{\dirAccuracy}{95.42\%\xspace}
\newcommand{\wildHours}{???\xspace}
\newcommand{\wildEvents}{???\xspace}
\newcommand{\wildAccuracy}{???\%\xspace}
...
\title[Doorway Sensing with \sysname]{\sysname: Batteryless Occupancy Monitoring \\with Reflected Ambient Light}
%Alternative Title suggestion:  "Waldo: An Unobtrusive Batteryless Doorway Sensor for Room-Level Occupancy Tracking". -NT
...
\renewcommand{\shortauthors}{H. Desai et al.}
