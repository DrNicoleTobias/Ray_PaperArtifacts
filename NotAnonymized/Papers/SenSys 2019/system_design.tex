...
%
\fxnote{[Not really sure how or where to address this, but only one of the locations used to train the decision tree is being used as a testing doorway in the ITW study... just wanted to mention it incase someone see a good place to mention it - it at all. -NT]}
\fxnote{[I think it goes in eval. --JMS]}
%
