This code is written by XXXX XXXX to decode Enocean sensor packet and logged the decoded data into a database. Follow the steps below in order to run the codes:
...
Database:
https://www.XXXX.edu/phpmyadmin/index.php
