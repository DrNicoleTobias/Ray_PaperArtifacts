This folder contains all PCB hardware module files, Bill of Materials (BOM) associated with each module and the design files to 3D print a prototyping enclosure and cap/cover for the finished sensor PCB.
