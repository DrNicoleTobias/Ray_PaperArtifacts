...
The detector circuitry is made using nano-power comparators (TI~TLV3691) and a passive RC filter network. The RC filter network is tunable using trim potentiometers pre-installation or digital potentiometers in deployment.  \fxnote{[There are no digipots in the current system.  If this is talking about their overall use potentially then it is probably fine to mention them.-NT]}
...
The total cost of the current prototype at the time of submission, including all PCBs, component parts, Radio modules, and solar panels is \$23.18 per unit if ordered in quantities of 1000\footnote{PCBs priced by SeeedStudios.com.}.
