...
/* ------------------------------------------------------------------------------------------------
 *                                SPI Configuration for Radio
 * ------------------------------------------------------------------------------------------------
 */

/* CSn Pin Configuration */  //CS P1.5
...
/* SCLK Pin Configuration */ //SCLK P2.2
...
/* SI Pin Configuration */  //MOSI P1.6
...
/* SO Pin Configuration */  //MISO P1.7
...
/* SPI Port Configuration */  //For 5994 -> MOSI(P1), MISO(P1), and SCLK(P2) have Sel1 = 1 and Sel0 = 0
#define SPI_CONFIG_PORT()                st( P1SEL0 &= ~(BV(SPI_SI_GPIO_BIT__) | BV(SPI_SO_GPIO_BIT__)); \
