...
\noindpar{Improving robustness and reliability:}
...
\\\sysname is not meant to be a standalone system in that it's true potential is realized as a part of a wider network of similar sensors.
