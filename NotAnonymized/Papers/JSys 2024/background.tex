...
Occupancy-monitoring applications try to instrument buildings, people, or other indoor elements to get a better understanding of the number of people in a room.
...
Ideally, it is a goal for all occupancy monitoring using energy harvesting to be robust enough to be able to handle these confounding factors, but all occupancy monitoring systems suffer from these confounding cases.%Any system that promises robust occupancy monitoring using energy harvesting must be able to handle these confounding factors.
