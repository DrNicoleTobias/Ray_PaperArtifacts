...
/* Radio CSn Pin Configuration P4.3*/
#define SPI_CSN_GPIO_BIT__             3
#define SPI_CONFIG_CSN_PIN_AS_OUTPUT()   st( P4DIR |=  BV(SPI_CSN_GPIO_BIT__); )
#define SPI_DRIVE_CSN_HIGH()             st( P4OUT |=  BV(SPI_CSN_GPIO_BIT__); ) /* atomic operation */
#define SPI_DRIVE_CSN_LOW()              st( P4OUT &= ~BV(SPI_CSN_GPIO_BIT__); ) /* atomic operation */
#define SPI_CSN_IS_HIGH()                 (  P4OUT &   BV(SPI_CSN_GPIO_BIT__) )

/* WuRx CS Pin Configuration P3.7*/
#define WKUP_SPI_CSN_GPIO_BIT__             7
#define WKUP_SPI_CONFIG_CSN_PIN_AS_OUTPUT()   st( P3DIR |=  BV(WKUP_SPI_CSN_GPIO_BIT__); )
#define WKUP_SPI_DRIVE_CSN_HIGH()             st( P3OUT |=  BV(WKUP_SPI_CSN_GPIO_BIT__); ) /* atomic operation */
#define WKUP_SPI_DRIVE_CSN_LOW()              st( P3OUT &= ~BV(WKUP_SPI_CSN_GPIO_BIT__); ) /* atomic operation */
#define WKUP_SPI_CSN_IS_HIGH()                  ( P3OUT &   BV(WKUP_SPI_CSN_GPIO_BIT__)  )
